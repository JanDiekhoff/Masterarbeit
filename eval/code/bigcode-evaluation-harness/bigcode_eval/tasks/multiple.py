...
language_map = {
            "humaneval-cpp":"C++",
            "humaneval-cs":"C#",
            "humaneval-js":"JavaScript",
            "humaneval-java":"Java",
            "humaneval-php":"PHP",
            "humaneval-rb":"Ruby",
            "humaneval-sh":"Shell",
            "humaneval-ts":"TypeScript",
            "mbpp-cpp":"C++",
            "mbpp-cs":"C#",
            "mbpp-js":"JavaScript",
            "mbpp-java":"Java",
...
def reformat_prompt(prompt):
    new_prompt = ""
    language = language_map[prompt["language"]]
    prompt = prompt["prompt"]

    match language:
        case "C++":
            new_prompt = prompt.split("//")[0] + "// <func> // C++\n//" + "//".join(prompt.split("//")[1:])
        case "C#":
            new_prompt = prompt.split("//")[0] + "// <func> // C#\n//" + "//".join(prompt.split("//")[1:])
        case "Java":
            new_prompt = prompt.split("//")[0] + "// <func> // Java\n//" + "//".join(prompt.split("//")[1:])
        case "JavaScript":
            new_prompt = "// <func> // JavaScript\n" + prompt
        case "PHP":
            new_prompt = prompt.split("php")[0] + "php\n" + "// <func> // PHP\n" + "php".join(prompt.split("php")[1:])
        case "Ruby":
            new_prompt = "# <func> # Ruby\n" + prompt
        case "Shell":
            new_prompt = "# <func> # Shell\n" + prompt
        case "TypeScript":
            new_prompt = "// <func> // TypeScript\n" + prompt
